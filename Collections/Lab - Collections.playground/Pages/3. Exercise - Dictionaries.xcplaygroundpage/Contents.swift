...
dictionary["January" ] = 31
dictionary["February"] = 28
dictionary["March"] = 31
print(dictionary)
...
if let numberDays = dictionary["January"] {
  print("anuary has \(numberDays) days")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors". Print the resulting dictionary.
var shapesArray = ["Shapes":["triangle","Circle","Star" ],"Colors":["red","black","silver"]]
print(shapesArray)
...
if let colors = shapesArray["Colors"] {
  print(" \(colors) ")
}
