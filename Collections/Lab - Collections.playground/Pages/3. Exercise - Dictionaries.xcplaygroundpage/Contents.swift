 ...
 */
var calender = ["January": 31, "February": 28, "March": 31]
print(calender)
...
calender.updateValue(29, forKey: "February")
print(calender)

//:  Use if-let syntax to retrieve the number of days under "January". If the value is there, print "January has 31 days", where 31 is the value retrieved from the dictionary.
if let januaryDays = calender["January"] {
    print("January has \(januaryDays) days")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors". Print the resulting dictionary.
var shapesArray = ["Circle", "Square", "Triangle"]
var colorsArray = ["Black", "Blue", "pink"]
var colorsAndShapes = ["Shapes": shapesArray, "Colors": colorsArray]
...
if let colors = colorsAndShapes["Colors"] {
