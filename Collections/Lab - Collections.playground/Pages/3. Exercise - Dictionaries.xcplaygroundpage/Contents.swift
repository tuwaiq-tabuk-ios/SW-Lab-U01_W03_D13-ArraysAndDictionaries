...
if let daysInJan = numberOfDays["January"]{
   print("January has \(daysInJan) days")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors". Print the resulting dictionary.
var shapesArray = ["tringle" , "Circle" , "square"]
var colorsArray = ["blue" , "Black" , "pinke"]
var shapesAndColorsArray : [String : String] = ["tringle":"blue","Circle":"Black","square":"pinke"]
