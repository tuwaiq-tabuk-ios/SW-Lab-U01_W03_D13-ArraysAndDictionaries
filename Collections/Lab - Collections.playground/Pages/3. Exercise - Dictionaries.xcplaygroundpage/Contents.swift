...
if let daysNumber = daysInMonth["January"] {
    print("January has \(daysNumber) days")
}
//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors". Print the resulting dictionary.
let shapesArray = ["Square", "Triangle", "Circle"]
let colorsArray = ["Blue", "Green", "White"]
var shapesesAndColors = ["shapes": shapesArray, "colors": colorsArray]
print(shapesesAndColors)
...
if let element = shapesesAndColors["colors"]?.last {
    print(element)
}
