 ...
 */
var walkingChallenges = ["Walk 5 miles a day","Walk 10 miles a day"]
var runningChallenges = ["Run 3 times a week","Run 5 times a week"]
...
if newChallenges .isEmpty {
  print("Can you commit a challenge please?")
}
else if newChallenges.count == 1 {
  print("The challenge you have chosen is \(newChallenges)")
}
else {
