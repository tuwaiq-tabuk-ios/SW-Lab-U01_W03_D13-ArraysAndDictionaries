...
walkingChallenges += ["Walk 3 miles a day","Walk 100 miles a week"]
runningChallenges += ["Run 5 miles a day","Run 5 times a week"]
calisthenicsChallenges += ["Jumb 8 times a day","Jumb 99 times a week"]
weightliftingChallenges += ["The Body Weight Squat Challenge","The Deadlift Challenge"]
...
challenges += [walkingChallenges,runningChallenges,calisthenicsChallenges,weightliftingChallenges]
...
var representChallenges = [String]()
representChallenges += ["Walk 3 miles a day","Run 5 miles a day"]

//:  Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."

if representChallenges.isEmpty {
  print("Please select challenge")
}else if representChallenges.count == 1 {
    print("The challenge you have chosen is : \(representChallenges[0])")
}else{
