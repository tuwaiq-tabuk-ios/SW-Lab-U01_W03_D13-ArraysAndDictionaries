...
print(" - - - Exercise 1 - - - ")
var walkingChallenges : [String] = ["World Walking" , "30 - Day Walking Challenge"]
var runningChallenges : [String] = [" Running Challeng" , "30 - Day Running Challeng"]
...
challenges += [walkingChallenges ,runningChallenges]
...
print(" - - - Exercise 4 - - - ")
var challengesTheUserHasCommittedTo = [String]()
//:  Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."
print(" - - - Exercise 5 - - - ")
if challengesTheUserHasCommittedTo.isEmpty{
  print("How do you feel about starting a challenge?")
} else if challengesTheUserHasCommittedTo.count == 1{
  print("The challenge you have chosen is walking challenge")
}else {
