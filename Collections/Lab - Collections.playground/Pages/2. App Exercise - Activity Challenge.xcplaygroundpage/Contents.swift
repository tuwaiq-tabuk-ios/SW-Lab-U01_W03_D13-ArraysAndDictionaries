...
var walkingChallenge = ["Walk 2 day ", "walk 14 for week"]

var runingChallenge = ["run 5 times for day", "run 10 times for week"]
...
var challenges = [walkingChallenge,runingChallenge]
print(challenges)
...
if walkingChallenge.isEmpty {
  print ("Please select challenge")
}else if runingChallenge.count == 1 {
    print ("the challenge you have choosen is : \(runingChallenge)")
