...
registrationList += ["Hajar", "Mona", "Manal","Amal"]
print(registrationList)
...
//there is a easier way to modify this element value but it brings an error when i tried it!
//tregistrationList[6] = "Rebecca"
